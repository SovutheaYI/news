            ...
            <View>
                ...
                >
                    <Card
                        ...
                        image={{uri: 'https://123sovutheatech.000webhostapp.com/postimages/' + img}}
                    >
                        <Text style={{marginBottom: 10}} numberOfLines={3}>
                            {detail || 'Read More..'}
                        </Text>
                        <Text style={{marginBottom: 10}}>Read More..</Text>
                        <Divider style={{backgroundColor: '#dfe6e9'}} />
                        <View
                            style={{ flexDirection: 'row', justifyContent: 'space-between' }}
                        >
                            {/* <Text style={noteStyle}>{url.toUpperCase()}</Text> */}
                            <Text style={noteStyle} onPress={ ()=> Linking.openURL(url) } >REF. LINK</Text>
...
export default withNavigation(SportNews);